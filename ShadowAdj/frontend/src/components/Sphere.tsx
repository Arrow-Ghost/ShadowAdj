...
/**
 * Real-time audio sphere. Vertex displacement follows live FFT frequency bins;
 * colour follows the pace descriptor (measured / steady / fast).
 * Surrounded by an ambient breathing particle field.
 */
export default function Sphere({
  ...
  useEffect(() => {
    ...
    const key = new THREE.PointLight(0xffffff, 45, 25);
    ...
    const animate = (now: number) => {
      ...
      mat.emissiveIntensity = 0.35 + smooth * 0.85;
      ...
      particleMat.color.copy(target);
      particleMat.opacity = 0.25 + smooth * 0.5;
